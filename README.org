...
utilidad a los usuarios que deseen conocer mejor el poder Emacs.
...
El último paquete es un mero capricho respecto a una de las variantes de
colores que personalmente me gusta (modus-operandi-tinted y su variación en
dark, modus-vivendi-tinted), dado que ya en la versión 28 de Emacs el paquete
modus-themes ya viene por defecto instalado.
...
entraria a conocerlo de manera un poco más amigable.
...
otro directorioy luego de eso copiar estos archivos dentro de la carpeta
".emacs.d".
