...
Esta es una configuración muy básica, pero a la vez cómoda que he podido probar con éxito en la versión 28 y 27 de Emacs, y en las distribuciones de Ubuntu, Fedora, Gentoo y Openbsd. En realidad es una configuración muy mínima y simple por lo que no tendría por qué no funcionar en cualquier otra distribución.

Como bien deslizaba en el párrafo anterior, se trata de la configuración básica y minimalista que personalmente he tratado de mantener, pero estimo sinceramente que, puede ser de utilidad a los usuarios que deseen conocer por primera vez la capacidad de Emacs.
...
Para hacerlo aun más didáctico este mismo archivo ya se encuentra con esa configuración y si quieres probar cómo funciona basta con seguir los siguientes pasos:
