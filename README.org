...
Esto puede variar, en general esa es la idea.
...
Para hacerlo aun más didáctico este mismo archivo ya se encuentra con esa configuración y si quieres probar como funciona basta con presionar C-c e, y luego: l (Latex), o (generar archivo pdf y abrirlo).
