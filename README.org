...
#+begin_src emacs-lisp
  ...
  (setq user-full-name "Lucas Fernandez")
  ...
  (defun my-show-org-agenda-on-connect ()
    "Mostrar org-agenda cuando el cliente de Emacs se conecta al servidor."
    (when (equal (buffer-name) "*scratch*") ; Solo se ejecuta en el buffer *scratch*
      (org-agenda-list)
      (delete-other-windows)))

  (add-hook 'server-after-make-frame-hook 'my-show-org-agenda-on-connect)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-todo-keywords
        '((sequence "TODO" "EN CURSO" "ESPERANDO" "|" "DONE" "CANCELADO" "POSTERGADO")))

  (setq org-agenda-columns-add-appointments-to-effort-sum t)
  (setq org-agenda-columns-add-appointments-to-effort-sum "Eff")
  (setq org-agenda-columns-compute-summary-properties "Effort(Effort)")

  ;; Files
  (setq org-agenda-files '("~/Public/docs/notes/"))


  ;; Configurar directorio de notas
  (setq org-directory "~/Public/docs/files/nots")

  ;; Configurar agenda personalizada
  (setq org-agenda-custom-commands
        '(("c" "Agenda y tareas pendientes"
           ((agenda "")
            (todo "TODO")))
          ("n" "Notas" tags "NOTE")
          ))
  ;; Definir la etiqueta para notas
  (setq org-tag-alist '(("NOTE" . ?n)
                        ("IMPORTANTE" . ?i)
                        ("TRABAJO" . ?t)))


  ;; Configurar Org Captures
  (define-key global-map (kbd "C-c c") 'org-capture)
  (setq org-capture-templates
        '(("t" "Tarea" entry (file+headline "~/Public/docs/notes/tareas.org" "Tareas pendientes")
           "* TODO %?\n %i\n %a")
          ("n" "Nota" entry (file+headline "~/Public/docs/notes/notas.org" "Notas")
           "* %? :NOTE:\n %i\n %a\n"
           :prepend t
           :empty-lines 1
           :prepend-value (concat (format-time-string "[%Y-%m-%d %H:%M]") "\n") 
           )))
...
#+begin_src emacs-lisp
  ...
  ;; Configuración para sincronización con Evince y SyncTeX
  (setq TeX-source-correlate-start-server t)
  (setq TeX-source-correlate-mode t)
  (setq TeX-view-program-selection '((output-pdf "Evince")))
  (setq TeX-source-correlate-method 'synctex) ; Opción para utilizar SyncTeX
